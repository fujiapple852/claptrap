...
hero:
  ...
  image:
    ...
    light: ../../../assets/0.3.0/logo.png
    dark: ../../../assets/0.3.0/logo.png
  actions:
    - text: Get Started
      link: /0.3.0/start/getting-started/
      icon: right-arrow
    - text: Read the docs
      link: /0.3.0/reference/overview/
      icon: open-book
    - text: View on GitHub
...
<CardGrid>
  <Card title="Powered by Clap" icon="rocket">
    Claptrap brings the [full power](https://claptrap.sh/reference/api/) of [Clap](https://crates.io/crates/clap) command line parsing to shell scripts.
  </Card>
  ...
  <Card title="Run Anywhere" icon="seti:info">
    Supports `bash`, `zsh`, `fish` and `PowerShell` and can run on Linux, BSD, macOS, and Windows.
  </Card>

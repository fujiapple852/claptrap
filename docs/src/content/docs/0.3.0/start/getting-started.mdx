...
sidebar:
  order: 2
slug: 0.3.0/start/getting-started
---
...
<Steps>
  1. Install Claptrap:
     ...
     See the [installation guide](/0.3.0/start/installation) for details of how to install Claptrap on your system.
...
For more details on how to use Claptrap, see the [usage guide](/0.3.0/guides/usage) and the [reference](/0.3.0/reference/overview) documentation.

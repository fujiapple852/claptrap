...
See the [API Reference](/0.3.0/reference/api) for details of the specification format and examples.
...
when you want to avoid [installing](/0.3.0/start/installation) Claptrap on your host system.
...
The Claptrap [Docker image](/0.3.0/start/installation/#docker) expects the specification file to be mounted in the `/data/`

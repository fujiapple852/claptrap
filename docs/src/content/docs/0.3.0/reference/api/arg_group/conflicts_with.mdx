...
slug: 0.3.0/reference/api/arg_group/conflicts_with
---
...
# `conflicts_with` <LinkButton href="https://docs.rs/clap/latest/clap/struct.ArgGroup.html#method.conflicts_with" icon="open-book" variant="minimal" />

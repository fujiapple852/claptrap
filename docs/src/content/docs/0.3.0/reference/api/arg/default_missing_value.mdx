...
slug: 0.3.0/reference/api/arg/default_missing_value
---
...
# `default_missing_value` <LinkButton href="https://docs.rs/clap/latest/clap/struct.Arg.html#method.default_missing_value" icon="open-book" variant="minimal" />

...
slug: 0.3.0/reference/api/arg/required_if_eq
---
...
# `required_if_eq` <LinkButton href="https://docs.rs/clap/latest/clap/struct.Arg.html#method.required_if_eq" icon="open-book" variant="minimal" />

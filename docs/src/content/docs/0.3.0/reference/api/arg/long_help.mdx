...
sidebar:
  label: long_help
slug: 0.3.0/reference/api/arg/long_help
---
...
# `long_help` <LinkButton href="https://docs.rs/clap/latest/clap/struct.Arg.html#method.long_help" icon="open-book" variant="minimal" />

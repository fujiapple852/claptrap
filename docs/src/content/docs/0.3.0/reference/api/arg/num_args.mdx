...
sidebar:
  label: num_args
slug: 0.3.0/reference/api/arg/num_args
---
...
# `num_args` <LinkButton href="https://docs.rs/clap/latest/clap/struct.Arg.html#method.num_args" icon="open-book" variant="minimal" />

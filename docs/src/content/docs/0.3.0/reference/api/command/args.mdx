...
sidebar:
  label: args
slug: 0.3.0/reference/api/command/args
---
...
# `args` <LinkButton href="https://docs.rs/clap/latest/clap/struct.Command.html#method.args" icon="open-book" variant="minimal" />

...
sidebar:
  label: multicall
slug: 0.3.0/reference/api/command/multicall
---
...
# `multicall` <LinkButton href="https://docs.rs/clap/latest/clap/struct.Command.html#method.multicall" icon="open-book" variant="minimal" />

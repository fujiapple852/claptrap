...
sidebar:
  label: flatten_help
slug: 0.3.0/reference/api/command/flatten_help
---
...
# `flatten_help` <LinkButton href="https://docs.rs/clap/latest/clap/struct.Command.html#method.flatten_help" icon="open-book" variant="minimal" />

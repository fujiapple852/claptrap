...
fn build_example(module: &str, base: &str) -> Result<Example> {
    let spec_path = format!("crates/claptrap-core/tests/resources/{module}/{base}.toml");
    let args_path = format!("crates/claptrap-core/tests/resources/{module}/{base}.args");
    let snap_path = format!("crates/claptrap-core/tests/snapshots/tests__{module}__{base}.snap");
...
fn collect_examples(module: &str, slug: &str) -> Result<Vec<Example>> {
    let base_dir = Path::new("crates/claptrap-core/tests/resources").join(module);
